...
public class MyReporter{
	...
	private static synchronized void myLog(String s, ITestResult m) {
	 ...
	 * out too
	 */
	public static void myLog(String s, int level, boolean logToStandardOut) {
	 ...
	 * out too
	 */
	public static void myLog(String s, boolean logToStandardOut) {
		myLog(s, getCurrentTestResult());
		if (logToStandardOut) {
			System.out.println(s);
		}
	 ...
	 * @param level The verbosity of this message
	 */
	public static void myLog(String s, int level) {
		if (TestRunner.getVerbose() >= level) {
			myLog(s, getCurrentTestResult());
		}
	}
