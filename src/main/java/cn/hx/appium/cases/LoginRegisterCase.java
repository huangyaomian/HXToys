...
public class LoginRegisterCase extends CaseBase{
	public static Map<String, AndroidDriverBase> driverMap = new HashMap<String, AndroidDriverBase>();
	...
	@AfterSuite
	public void quit(){
		for(String udid : driverMap.keySet()){
			AndroidDriverBase dr = driverMap.get(udid);
			dr.quit(udid);
		}
	}
}
